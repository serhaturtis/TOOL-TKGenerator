...
class CheckBox(tk.Frame):
    ...
    def __init__(self, text, callback, master=None):
        ...
        self.button = tk.Checkbutton(self, text=text, variable=self.bool_variable, command=self.state_callback, onvalue=True, offvalue=False)
...
class SingleLineConsole(tk.Frame):
    ...
    def write_info(self, text):
        self.console_label.configure(fg='green')
        self.console_stringvar.set('INFO: ' + text)

    def write_error(self, text):
        self.console_label.configure(fg='red')
